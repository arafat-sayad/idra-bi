...
nonlife_admin_sidebar <- list(
    
    selectInput("selectinput", "Company", choices = nonlife_select_options, selected = "All"),
    sidebarMenu( id = "tabs",
        ...
        #menuItem("Advanced Analysis", tabName = "nonlife_admin_advanced_analysis", icon = icon("chart-line"))
    ...
    tabItems(
        ...
        tabItem(
            ...
            fluidRow(
              ...
              column(12,
                     uiOutput("total_policy_count"),
                     uiOutput("total_expired_policy_count"),
                     uiOutput("total_cancelled_policy_count")
                     ),
        ...
        #             
        #             plotlyOutput("linechart_day_1.1"),
        #             width = 12),
        #         box(
        ...
        #             plotlyOutput("linechart_month_1.2")
        #         ),
        #         box(
        ...
        #             ),
        #             plotlyOutput("linechart_year_1.3")
        #         )
        #     )
        # ),
        ...
        tabItem( 
            ...
            fluidRow(
                ...
                box(
                    ...
                    dateRangeInput("daterange_2", "Chose a Date Range", "2021-10-01", today() ),
                    width = 12),
                ...
                box(
                    ...
                    pickerInput(
                        ...
                        label = "Companies", 
                        choices = nonlife_company_picker,
                        selected = nonlife_company_picker[1:3],
                        multiple = TRUE
                    ),
                    actionButton(
                ...
                box(
                    ...
                    width = 12,
                    selectInput("selectyear_premium_comparison", "Select a Year", choices = sort(year_choices), selected = 2021),
        ...
        tabItem(
            ...
            fluidRow(
              ...
              column(12,
                     uiOutput("bank_deposited_policy"),
                     uiOutput("valid_mobile_number"),
                     uiOutput("valid_email_address")
              ),
              column(12,
                     uiOutput("policydate_vs_number_value"),
                     uiOutput("covernote_present_policy_absent"),
                     uiOutput("covernote_policy_both_present")
                     ),
        ...
        tabItem(
            ...
            box(
                title = "Insurance Status by Company",status = "primary", solidHeader = TRUE,
                DTOutput("policycover_datatable"),
                width = 12
            )
        )
        ...
        # tabItem(
        #     tabName = "nonlife_admin_advanced_analysis",
        #     
        #     tabsetPanel(
        #         tabPanel("Trend",
        #                  column(12,
        #                         selectInput("nonlife_admin_trend_type_select", "Trend: ", 
        #                                     c("Policy", "Premium"))
        #                  ),
        #                  column(12,
        #                         plotlyOutput("nonlife_admin_trend_plot",height = "600px")
        #                  )
        #         ),
        #         tabPanel("Forecast",
        #                  fluidRow(
        #                      
        #                      column(width = 6, selectInput("nonlife_admin_select_period", "Period to forecast (Months)", c(6,12,18), 12)),
        #                      column(width = 6, selectInput("nonlife_admin_forecast_product_type_select", "Forecast: ", 
        #                                                    c("Policy", "Premium")),
        #                             actionButton("nonlife_admin_forecastButton","Run Forecast", class = "btn-warning")
        #                      ),
        #                      column(12, hr(style = "border-color: #cbcbcb; margin-top: 2px; margin-bottom: 2px;")),
        #                      
        #                      column(12,
        #                             plotlyOutput("nonlife_admin_forecast_plot",height = "600px") %>% shinycssloaders::withSpinner()
        #                      )
        #                  )
        #         )
        #     )
