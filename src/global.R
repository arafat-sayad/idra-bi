...
union all
    select 'Bengal Islami' as company_name, dateofbirth, policystartdate, policyenddate,  status, riskstartdate, premiummode, gender, term, agentid from nrbglobal.policy 
union all
...
union all
    select 'Jiban Bima' as company_name, dateofbirth, policystartdate, policyenddate,  status, riskstartdate, premiummode, gender, term, agentid from jibanbima.policy 
union all
...
union all
    select 'NRB Islamic' as company_name, dateofbirth, policystartdate, policyenddate,  status, riskstartdate, premiummode, gender, term, agentid from nrbislamic.policy 
union all
...
table_name_of_life <- c("alpha","akij","astha", "baira", "bestlife", "chartered", "diamond", "delta", "fareast", "golden", "guardian", "homeland", "jamuna", "jibanbima",
                        "licb", "Meghnalife", "Mercantileislami", "metlife", "national", "nrbglobal", "nrbislamic", "padma", "popular", "pragatilife", "primeislami",
...
life_database_table_names <- read.csv("../data/life_database_table_names.csv")
...
union all
    select 'Bengal Islami' as company_name, ordate, ortype, totalpayableamount, officebranchcode, agentid from nrbglobal.originalreceipt
union all
...
union all
    select 'Jiban Bima' as company_name, ordate, ortype, totalpayableamount, officebranchcode, agentid from jibanbima.originalreceipt
union all
...
union all
    select 'NRB Islamic' as company_name, ordate, ortype, totalpayableamount, officebranchcode, agentid from nrbislamic.originalreceipt
union all
...
company_database_names <- readRDS("../data/company_database_names.RDS")
...
save(covernote_present_policy_absent,covernote_policy_both_present, policynumber_vs_issuedate, e_receipt_daily, e_receipt_monthly, totalvalidemail_sum_all, validemail_percent_sum_all, valid_email_address_sum, 
     ...
     monthwisetotal_p_count, file = "../data/nonlife_summarised_data.RData")
